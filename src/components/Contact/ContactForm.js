...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      <button type="submit" className="mt-8 font-medium inline-block capitalize text-xl py-3 px-8 border-2 border-solid rounded cursor-pointer">Send Request</button>
    </form>
  );
}
