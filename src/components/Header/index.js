...
const Header = () => {
  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
      ...
      <nav
        className="w-max py-3 px-6 sm:px-8 border border-solid border-dark rounded-full font-medium capitalize sm:hidden flex items-center fixed top-6 right-1/2 translate-x-1/2 bg-light/80 backdrop-blur-sm z-50 transition-all ease duration-200"
        style={{
          top: click ? "1rem" : "-5rem",
        }}
      >
